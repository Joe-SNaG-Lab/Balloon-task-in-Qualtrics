...
$(document).ready(function() { 
  ...
  var label_header = 'Balloon Game ';
  var label_gonext1 = 'Start next round';
  var label_gonext2 = 'end game';
  var msg_explosion1 = '<p> The balloon has popped!';
  var msg_explosion2 = ' times.</p> <p> You did not make any money this round </p>';
  var label_present_time = 'Pump Count:';
  var label_present_value = 'Earned this round:';		

  
  var msg_collect1 = '<p> The balloon did not burst! </ p> <p> You cashed in ';
  var msg_collect2 = ' Points. </ p> <p> The money earned is safe in the bank.</p>';

  var msg_end1 = '<p> This completes this part of the study. You earned ';
  var msg_end2 = ' dollars. </ p> <p> Click <i> Next </ i> to continue the study. </ p>';
  ...
  $('#collect').click(function() {
      if (pumps === 0) {
	alert('you can only cash in after pumping the balloon at least once');
      }
